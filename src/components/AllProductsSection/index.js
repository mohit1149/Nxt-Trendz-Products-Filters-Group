...
class AllProductsSection extends Component {
  ...
  getProducts = async () => {
    ...
    const apiUrl = `https://apis.ccbp.in/products?sort_by=${activeOptionId}&title_search=${activeProductId}&category=${activeCategoryId}&rating=${activeRatingId}`
    const options = {
      headers: {
  ...
  updatedSearchInput = activeProductId => {
    ...
    return (
      <div className="all-products-section">
        ...
        <FiltersGroup
          ...
          key={categoryOptions.categoryId}
          ...
          onClickClearFilterButton={this.onClickClearFilterButton}
          onEnterSearchInputs={this.onEnterSearchInputs}
        />
